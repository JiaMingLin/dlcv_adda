...
if __name__ == '__main__':
    ...
    # load dataset
    src_data_loader = get_data_loader('MNIST')
    src_data_loader_eval = get_data_loader('MNIST', train=False)
    
    tgt_data_loader = get_data_loader('USPS')
    tgt_data_loader_eval = get_data_loader('USPS', train=False)
